# 06_Esquema y Semillas de Base de Datos

Este documento sirve como registro histórico de la estructura de la base de datos y los datos de prueba iniciales (seeders) utilizados en la aplicación.
...
Estos datos se insertan automáticamente si la tabla de categorías está vacía.
...
### Productos (Muestra de 20+ registros)
